          ...
          subcommand
            ...
            .addChannelOption((option) =>
              option
                ...
                .setRequired(true)
                .setDescription(
                  `Select Channel That You Want To Send Ticket Panel.`,
                )
              ...
              subcommand
                ...
                .addRoleOption((option) =>
                  option
                    .setName(`support_role`)
                    .setDescription(
                      `Select Role Those Who Responds To Tickets.`,
                    )
                    .setRequired(true),
                ),
            )
  ...
  async run(client, interaction) {
    ...
    if (subcommand === "setup") {
      ...
      return await interaction.followUp({
        content: `Done✅. Use "/ticket send pannel" Command To Activate/Send Ticket.`,
      });
    }
    ...
    if (subcommand === "panel") {
      ...
      if (!check) {
        await interaction.deferReply({ ephemeral: true });
        return await interaction.followUp({
          content: `> You Have Not Setup Ticket System Yet. Use "/ticket setup" Command To Setup Ticket System.`,
        });
      }
      if (check) {
        ...
        await interaction.deferReply({ ephemeral: true });
        return await interaction.followUp({
          content: `Done✅. Activated/Sent Ticket Panel In <#${check}>.`,
        });
      }
    }
    ...
    if (subcommand === "role") {
      ...
      await interaction.deferReply({ ephemeral: true });
      return await interaction.followUp({
        content: `Done✅. Support Role Has Been Edited.`,
      });
    }
    ...
    if (subcommand === "category") {
      ...
      await interaction.deferReply({ ephemeral: true });
      return await interaction.followUp({
        content: `Done✅. Ticket Category Has Been Updated.`,
      });
    }
    ...
    if (subcommand === "logs") {
      ...
      await interaction.deferReply({ ephemeral: true });
      return await interaction.followUp({
        content: `Done✅. Ticket Logs Has Been Updated.`,
      });
    }
  }
};
