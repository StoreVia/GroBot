...
module.exports = class Report extends Command {
  constructor(client) {
    super(client, {
      data: new SlashCommandBuilder()
        .setName("report")
        .setDescription(
          "Report Any Bug Or Suggest Something For Bot Implimentation.",
        )
  ...
  async run(client, interaction) {
    ...
    client.channels.cache
      .get(`${process.env.reportlogschannel_id}`)
      .send({ embeds: [embed] });
    await interaction.deferReply({ ephemeral: true });
    await interaction.followUp({
      content: "Reported Successfully, Our Team Will Contact You Soon.",
    });
  }
};
