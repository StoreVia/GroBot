      ...
      data: new SlashCommandBuilder()
          ...
          group
            ...
            .addSubcommand((subcommand) =>
              subcommand
                .setName(`edit`)
                .setDescription(
                  `Edit Welcome Message When A User Join's Server.`,
                ),
            )
            .addSubcommand((subcommand) =>
              subcommand
        ...
        .addSubcommandGroup((group) =>
          group
            .setName(`dm-user`)
            .setDescription(
              `Edit User's Dm Welcome Message When That User Join's Server.`,
            )
            .addSubcommand((subcommand) =>
              subcommand
                .setName(`text-edit`)
  ...
  async run(client, interaction) {
    ...
    if (subcommand === "delete") {
      ...
      if (checkchannel) {
        ...
        await interaction.reply({
          content: `> Welcome Message System Was Now Disabled In ${channel}`,
          ephemeral: true,
        });
      }
      if (!checkchannel) {
        await interaction.reply({
          content: `> ${channel} Was Not Bounded To Welcome System.`,
          ephemeral: true,
        });
      }
    }
    ...
    if (subcommand === "background") {
      ...
      if (!backgoundcheck) {
        ...
        await interaction.reply({
          content: `> Done✅. Welcome Background Was Now Set.`,
          ephemeral: true,
        });
      }
      if (backgoundcheck) {
        db.set(`welcomebg_${interaction.guild.id}`, background);
        await interaction.reply({
          content: `> Done✅. Welcome Background Was Now Updated.`,
          ephemeral: true,
        });
      }
    }
    ...
    if (subcommand === "guide") {
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          `> **Note: **Use \`:emoji_name:\` To Use Emoji In Welcome Message,Use \`<a:emoji_name:emoji_id>\` To Use Emoji Gif In Welcome Message & This Message Also Inlcudes For Dm Messages.`,
        )
    ...
    if (subcommand === "edit") {
      ...
      const welcometextedit1 = new TextInputBuilder()
        ...
        .setLabel("Send's This Text When Some One Join Server.")
        .setStyle(TextInputStyle.Paragraph);
      const welcometextedit0 = new ActionRowBuilder().addComponents(
        welcometextedit1,
      );
    ...
    if (subcommand === "user") {
      ...
      const userdmoffcheck = db.fetch(
        `welcomedm_${interaction.guild.id}`,
        "off",
      );
      if (set === "on") {
        if (userdmoncheck) {
          await interaction.reply({
            content: `> Dm-User Was Already Enabled. If You Want To Edit Welcome Dm Message Use \`/welcome dm-user text-edit\` Command.`,
            ephemeral: true,
          });
        }
        if (!userdmoncheck) {
          ...
          const welcomedmusernew1 = new TextInputBuilder()
            ...
            .setStyle(TextInputStyle.Paragraph);
          const welcomedmusernew0 = new ActionRowBuilder().addComponents(
            welcomedmusernew1,
          );
      ...
      if (set === "off") {
        if (userdmoffcheck) {
          ...
          await interaction.reply({
            content: `> Done✅. Dm-User Was Disabled Now.`,
            ephemeral: true,
          });
        }
        if (!userdmoffcheck) {
          await interaction.reply({
            content: `> Dm-User Was Already Disabled.`,
            ephemeral: true,
          });
        }
      }
    ...
    if (subcommand === "text-edit") {
      ...
      const welcomedmuserold1 = new TextInputBuilder()
        ...
        .setLabel("Send's This DmText When Some One Join Server.")
        .setStyle(TextInputStyle.Paragraph);
      const welcomedmuserold0 = new ActionRowBuilder().addComponents(
        welcomedmuserold1,
      );
    ...
    if (subcommand === "color") {
      ...
      collector.on("collect", async (i) => {
        if (i.user.id != interaction.user.id) {
          await i.reply({
            content: "This Interaction Doesn't Belongs To You.",
            ephemeral: true,
          });
        }
        ...
        if (i.customId === "colors") {
          if (selected === "000000") {
            const embed = new EmbedBuilder()
              ...
              .setColor(`${process.env.ec}`)
              .setDescription(
                `Done✅. Your Welcome Text Color Was Now Set To Black.`,
              )
              .setFooter({
                text: `${client.user.username} - ${process.env.year} ©`,
                iconURL: process.env.iconurl,
          ...
          if (selected === "FFFFFF") {
            const embed = new EmbedBuilder()
              ...
              .setColor(`${process.env.ec}`)
              .setDescription(
                `Done✅. Your Welcome Text Color Was Now Set To White.`,
              )
              .setFooter({
                text: `${client.user.username} - ${process.env.year} ©`,
                iconURL: process.env.iconurl,
          ...
          if (selected === "FFA500") {
            const embed = new EmbedBuilder()
              ...
              .setColor(`${process.env.ec}`)
              .setDescription(
                `Done✅. Your Welcome Text Color Was Now Set To Orange.`,
              )
              .setFooter({
                text: `${client.user.username} - ${process.env.year} ©`,
                iconURL: process.env.iconurl,
          ...
          if (selected === "87CEEB") {
            const embed = new EmbedBuilder()
              ...
              .setColor(`${process.env.ec}`)
              .setDescription(
                `Done✅. Your Welcome Text Color Was Now Set To Blue.`,
              )
              .setFooter({
                text: `${client.user.username} - ${process.env.year} ©`,
                iconURL: process.env.iconurl,
          ...
          if (selected === "FF0000") {
            const embed = new EmbedBuilder()
              ...
              .setColor(`${process.env.ec}`)
              .setDescription(
                `Done✅. Your Welcome Text Color Was Now Set To Red.`,
              )
              .setFooter({
                text: `${client.user.username} - ${process.env.year} ©`,
                iconURL: process.env.iconurl,
          ...
          if (selected === "964B00") {
            const embed = new EmbedBuilder()
              ...
              .setColor(`${process.env.ec}`)
              .setDescription(
                `Done✅. Your Welcome Text Color Was Now Set To Brown.`,
              )
              .setFooter({
                text: `${client.user.username} - ${process.env.year} ©`,
                iconURL: process.env.iconurl,
          ...
          if (selected === "A020F0") {
            const embed = new EmbedBuilder()
              ...
              .setColor(`${process.env.ec}`)
              .setDescription(
                `Done✅. Your Welcome Text Color Was Now Set To Purple.`,
              )
              .setFooter({
                text: `${client.user.username} - ${process.env.year} ©`,
                iconURL: process.env.iconurl,
          ...
          if (selected === "00FF00") {
            const embed = new EmbedBuilder()
              ...
              .setColor(`${process.env.ec}`)
              .setDescription(
                `Done✅. Your Welcome Text Color Was Now Set To Green.`,
              )
              .setFooter({
                text: `${client.user.username} - ${process.env.year} ©`,
                iconURL: process.env.iconurl,
          ...
          if (selected === "FFFF00") {
            const embed = new EmbedBuilder()
              ...
              .setColor(`${process.env.ec}`)
              .setDescription(
                `Done✅. Your Welcome Text Color Was Now Set To Yellow.`,
              )
              .setFooter({
                text: `${client.user.username} - ${process.env.year} ©`,
                iconURL: process.env.iconurl,
    ...
    if (subcommand === "template") {
      ...
      const embed = new EmbedBuilder()
        ...
        .setColor(`${process.env.ec}`)
        .setImage(
          `https://media.discordapp.net/attachments/1097119486986960968/1097191953361285201/Discord_Templates.png`,
        )
        .setFooter({
          text: `${client.user.username} - ${process.env.year} ©`,
          iconURL: process.env.iconurl,
      ...
      collector.on("collect", async (i) => {
        ...
        if (i.customId === "one") {
          ...
          await i.update({
            content: "Done✅. Template 1 Has Been Choosen.",
            embeds: [],
            components: [],
          });
        }
        if (i.customId === "two") {
          ...
          await i.update({
            content: "Done✅. Template 2 Has Been Choosen.",
            embeds: [],
            components: [],
          });
        }
