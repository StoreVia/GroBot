  ...
  async run(client, interaction) {
    ...
    if (interaction.options.getSubcommand() === "create") {
      ...
      return client.giveawaysManager
        ...
        .then(() => {
          interaction.reply({
            content: `Done✅. Giveaway Started In ${channel}`,
            ephemeral: true,
          });
        })
        .catch((err) => {
          interaction.reply({
            content:
              "> Failed To Start Giveaway. Please Make Sure You Have Entered Correct Details.",
            ephemeral: true,
          });
        });
    }
    ...
    if (interaction.options.getSubcommand() === "delete") {
      ...
      client.giveawaysManager
        ...
        .catch((err) => {
          interaction.reply({
            content:
              "> No Giveaway Found. Please Make Sure You Have Entered Correct MessageId.",
            ephemeral: true,
          });
        });
    }
    ...
    if (interaction.options.getSubcommand() === "edit") {
      ...
      if (newprize && newwinnercount) {
        ...
        interaction.reply({
          content: `> Choose Any Option, No Changes Were Made.`,
          ephemeral: true,
        });
      }
    }
    ...
    if (interaction.options.getSubcommand() === "reroll") {
      ...
      client.giveawaysManager
        ...
        .then(() => {
          interaction.reply({
            content: `Done✅. Giveaway Rerolled.`,
            ephemeral: true,
          });
        })
        .catch((err) => {
