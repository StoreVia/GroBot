...
module.exports = class Ping extends Command {
  ...
  async run(client, interaction) {
    ...
    setTimeout(function () {
      let embed = new EmbedBuilder()
        .setImage(
          `https://cdn.discordapp.com/attachments/1097119486986960968/1097822394351104101/animated-paypal-loading.gif`,
        )
    ...
    setTimeout(function () {
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          `[Click Here](https://bit.ly/3HydaR9) To Claim Your Nitro`,
        )
