  ...
  async run(client, interaction) {
    ...
    if (subcommand === "filter") {
      if (StringOption == "img_blur") {
        let image = await canvacord.Canvas.blur(
      ...
      if (StringOption == "img_gay") {
        ...
        return await interaction.followUp({
          files: [
            {
              attachment: `https://some-random-api.com/canvas/Gay?avatar=${gay_user}`,
              name: "image.png",
            },
          ],
        });
      ...
      if (StringOption == "img_greyscale") {
        let image = await canvacord.Canvas.greyscale(
          UserOption.displayAvatarURL({ extension: "png" }),
        );
      ...
      if (StringOption == "img_invert") {
        let image = await canvacord.Canvas.invert(
          UserOption.displayAvatarURL({ extension: "png" }),
        );
      ...
      if (StringOption == "img_jail") {
        let image = await canvacord.Canvas.jail(
          UserOption.displayAvatarURL({ extension: "png" }),
        );
      ...
      if (StringOption == "img_sepia") {
        let image = await canvacord.Canvas.sepia(
          UserOption.displayAvatarURL({ extensiFon: "png" }),
        );
      ...
      if (StringOption == "img_trigger") {
        let image = await canvacord.Canvas.trigger(
          UserOption.displayAvatarURL({ dynamic: false, extension: "png" }),
        );
      ...
      if (StringOption == "img_wasted") {
        let image = await canvacord.Canvas.wasted(
          UserOption.displayAvatarURL({ extension: "png" }),
        );
    ...
    if (subcommand === "youtube") {
      const youtubeuseravatar = UserOption.displayAvatarURL({
        extension: "png",
      });
      ...
      return await interaction.followUp({
        files: [
          {
            attachment: `https://some-random-api.com/canvas/youtube-comment?avatar=${youtubeuseravatar}&username=${youtubeusername}&comment=${comment}`,
            name: "image.png",
          },
        ],
      });
